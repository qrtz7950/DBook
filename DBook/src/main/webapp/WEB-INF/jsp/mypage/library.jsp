		...
		<!-- Scripts -->
			...
			function addCookieBooks(data) {
				...
				for(var i=0; i<data.items.length; i++){
					...
					temp += 		'<article>';
					temp += 			'<a href="${pageContext.request.contextPath}/book/bookDetail/' + data.items[i].book_id + '.do" class="image"><img src="' + data.items[i].cover + '" onError="this.onerror=null;this.src=\'${pageContext.request.contextPath}/resources/images/image-null.png\';"/></a>';
